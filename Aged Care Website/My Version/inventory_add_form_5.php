...
echo '</ul>';
?>
<form action="inventory_add_5.php" method="POST">
<p><b>Cleaning supplies</b></p>
        <label for="citem">Item:</label>
        <input type="text" name="citem">
        <br><br> <!--Break-->
        <label for="cquan">Quantity:</label>
        <input type="text" name="cquan">
        <br><br> <!--Break-->
        <label for="csupp">Supplier:</label>
        <input type="text" name="csupp">
        <br><br> <!--Break-->
