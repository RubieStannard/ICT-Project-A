...
// Create the table
$create = "CREATE TABLE IF NOT EXISTS inventory5 (
...
if (isset($_POST["citem"], $_POST["cquan"], $_POST["csupp"])) { 
    $citem = $_POST["citem"];
    $cquan = $_POST["cquan"];
    $csupp = $_POST["csupp"];
    // Set up SQL string and execute - get data from user, escape it, trust no-one. :)
    $query = "INSERT INTO inventory (item, quantity, supplier) VALUES ('$citem', '$cquan', '$csupp')"; // Insert the data
