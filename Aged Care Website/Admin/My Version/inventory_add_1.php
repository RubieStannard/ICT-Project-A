...
// Create the table
$create = "CREATE TABLE IF NOT EXISTS inventory1 (
...
if (isset($_POST["mitem"], $_POST["mquan"], $_POST["msupp"])) { 
    $mitem = $_POST["mitem"];
    $mquan = $_POST["mquan"];
    $msupp = $_POST["msupp"];
    // Set up SQL string and execute - get data from user, escape it, trust no-one. :)
    $query = "INSERT INTO inventory (item, quantity, supplier) VALUES ('$mitem', '$mquan', '$msupp')"; // Insert the data
