...
echo '</ul>';
?>
<form action="inventory_add_1.php" method="POST">
<p><b>Mecication</b></p>
        <label for="mitem">Item:</label>
        <input type="text" name="miten">
        <br><br> <!--Break-->
        <label for="mquan">Quantity:</label>
        <input type="text" name="mquan">
        <br><br> <!--Break-->
        <label for="msupp">Supplier:</label>
        <input type="text" name="msupp">
        <br><br> <!--Break-->
